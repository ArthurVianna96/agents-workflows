...
- Follow [the shared skill convention](skills/miscellaneous/create-skills/SKILL.md): matching lowercase-hyphenated directory and `name`, a concise trigger description, one H1, and imperative instructions.
