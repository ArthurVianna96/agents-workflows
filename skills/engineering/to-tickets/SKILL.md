...
Publish the approved tickets. **How** depends on the tracker configured by `setup-skills`; the tickets are the same either way, only the shape of the blocking edges changes:
