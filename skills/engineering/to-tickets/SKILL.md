---
name: to-tickets
description: Break an agreed plan, specification, or conversation into vertical-slice tickets with explicit blockers for the configured tracker. Use when implementation work needs to be tracked or delegated.
---
...
Publish the approved tickets. **How** depends on the tracker configured by `setup-engineering-skills`; the tickets are the same either way, only the shape of the blocking edges changes:
