---
name: triage
description: Move issues and external pull requests through a state machine of triage roles, categorize them, verify claims, and write agent-ready briefs. Use when an issue needs classifying, an inbound report needs verifying, or a ticket must be made ready for an agent.
---
